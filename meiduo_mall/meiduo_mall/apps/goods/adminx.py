...
class SKUAdmin(object):  # 只需要继承 object 就足够了，不需要 admin.ModelAdmin
    model_icon = 'fa fa-gift'
    list_display = ['id', 'name', 'price', 'stock', 'sales', 'comments']
    search_fields = ['id', 'name']
    list_filter = ['category']
    list_editable = ['price', 'stock']  # 不需要进详情页就可以快速编辑
    show_detail_fields = ['name']
    list_export = ['xls', 'csv', 'xml']  # 允许的导出格式
    readonly_fields = ['sales', 'comments']  # 只读字段 不想让前端编辑


xadmin.site.register(models.SKU, SKUAdmin)  # 模型类 + 管理法
